      ...
      >
        <template slot="items" slot-scope="props">
          ...
          <td class="text-xs-center">
            ...
            <v-tooltip top >
              <v-btn class="ma-0" icon :to="{name:'farmOwner-editFarmOwner',params : {id : props.item.id}}"
                     slot="activator">
  ...
  export default {
    ...
    methods: {
      ...
      loadData: async function () {
        ...
        let page = await this.$store.dispatch('admin/farmers/getFarmers', this.form);
        this.paginate = page;
      ...
      delFarmer: async function (id) {
        ...
        if (confirm("Do you want to delete this item?")) {
          let data = await this.$store.dispatch("admin/farmers/deleteFarmerById", id);
          if (data) {
