    ...
    export default {
      ...
      methods : {
        ...
        load :async function () {
          ...
          this.chartData[0] = await  await this.$store.dispatch("admin/charts/getChart",CP239)
          this.displayChart(0);
          ...
          this.chartData[1] = await  await this.$store.dispatch("admin/charts/getChart",CA239)
          this.displayChart(1);
          ...
          this.chartData[2] = await  await this.$store.dispatch("admin/charts/getChart",CP240)
          this.displayChart(2);
          ...
          this.chartData[3] = await  await this.$store.dispatch("admin/charts/getChart",CA240)
          this.displayChart(3);
          ...
          this.chartData[4] = await  await this.$store.dispatch("admin/charts/getChart",CP241)
          this.displayChart(4);
          ...
          this.chartData[5] = await  await this.$store.dispatch("admin/charts/getChart",CA241)
          this.displayChart(5);
          ...
          this.chartData[6] = await  await this.$store.dispatch("admin/charts/getChart",CP242)
          this.displayChart(6);
          ...
          this.chartData[7] = await  await this.$store.dispatch("admin/charts/getChart",CA242)
          this.displayChart(7);
          ...
          this.chartData[8] = await  await this.$store.dispatch("admin/charts/getChart",CP243)
          this.displayChart(8);
          ...
          this.chartData[9] = await  await this.$store.dispatch("admin/charts/getChart",CA243)
          this.displayChart(9);
        },
