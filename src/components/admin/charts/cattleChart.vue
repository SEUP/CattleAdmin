    ...
    export default {
      ...
      methods : {
        ...
        load : async function () {
          ...
          this.chartData[0] = await this.$store.dispatch("admin/charts/getChart",male)
          ...
          this.chartData[1] = await this.$store.dispatch("admin/charts/getChart",female)
          this.displayChart(1);
          ...
          this.chartData[2] = await this.$store.dispatch("admin/charts/getChart",maleOverSix)
          this.displayChart(2);
          ...
          this.chartData[3] = await this.$store.dispatch("admin/charts/getChart",femaleOverSix)
          this.displayChart(3);
          ...
          this.chartData[4] = await this.$store.dispatch("admin/charts/getChart",maleUnderSix)
          this.displayChart(4);
          ...
          this.chartData[5] = await this.$store.dispatch("admin/charts/getChart",femaleUnderSix)
          this.displayChart(5);
