...
<script>
  ...
  export  default  {
    ...
    async created () {
      this.items = await this.$store.dispatch("choices/getChoicesByType",'cattle_sales')
      this.price =  [defaultChoice].concat(await this.$store.dispatch("choices/getChoicesByType",'price_breeding_sale'))
      this.age =    [defaultChoice].concat(await this.$store.dispatch("choices/getChoicesByType",'age_breeding_sale'))
